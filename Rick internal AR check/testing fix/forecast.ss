...
81  #FirstYear for caps and allocations (should be after years with fixed inputs) 
0 # stddev of log(realized catch/target catch) in forecast (set value>0.0 to cause active impl_error)
0 # Do West Coast gfish rebuilder output (0/1) 
75 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
80 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
...
-1 # basis for input Fcast catch:  -1=values are fleet/time specific as below (units are from fleetunits; note new codes in SSV3.20)
